...
Для того, то бы установить программу VSCode нужно перейти на сайт [VSCode](https://code.visualstudio.com/)

В зависимости от вашей операционной системы выбрать нужную и скачать на свой ПК

После установки, *программа* будет готова к использованию 
